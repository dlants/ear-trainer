  ...
  constructor(
    ...
    container.innerHTML = sanitize`
      <div class="${trialClass}">
        ...
        <div class="${rowClass}">
          <button type="button" data-ref="${contextRef}">key</button>
          <button type="button" data-ref="${patternRef}">play</button>
        </div>
        <div class="${rowClass}" data-ref="${commitRowRef}">
          <button type="button" data-ref="${unsureRef}">unsure</button>
          <button type="button" data-ref="${knownRef}">known</button>
        </div>
        <div class="${rowClass}" data-ref="${outcomeRowRef}">
          <button type="button" data-ref="${missedRef}">missed</button>
          <button type="button" data-ref="${gotItRef}">got it</button>
        </div>
      </div>
    `;
    ...
    this.b.bindText(modeRef, (s) => s.trial?.card.mode ?? "");
